...
int calculeazaInaltimeArbore(Nod* radacina) {
	...
	int inaltimeMaxima = (inaltimeStanga > inaltimeDreapta) ? inaltimeStanga : inaltimeDreapta;
...
int main() {
	...
	const char* numeTest = "Ionescu"; 
	printf("Pret total masini pentru soferul %s: %.2f\n", numeTest, calculeazaPretulMasinilorUnuiSofer(arbore, numeTest));
